...
/* add src values to img elements based on order specified in the photoOrder array */
...
/* stop automatic image switching and call rightArrow() function */
function rightArrow()
{
	clearInterval()
	{
...
function previewThree()
{
	...
	{
		numberButton.datachEvent("onclick", previewThree);
		numberButton.attachEvent("onclick", previewFive);
	}
}

/* open centre figure in separate window */
function zoomFig() 
{
	/*
...
/* create event listeners for left arrow, right arrow, and centre figure element. */
